...
#ifndef _PSPHA_SPI_H_INCLUDED
#define _PSPHA_SPI_H_INCLUDED
...
//	}
	...
	// PSPHA: Custom Functions :))))) pls work
	void customTransfer(const uint8_t * buf, uint8_t * retbuf, size_t count_write, size_t count_read);
	void customDoubleTransfer(const uint8_t * buf1, const uint8_t * buf2, size_t count_write1, size_t count_write2);
