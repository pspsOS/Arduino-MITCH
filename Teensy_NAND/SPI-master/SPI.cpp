...
void SPIClass::customTransfer(const void * buf, void * retbuf, size_t count_write, size_t count_read)
{
...
void SPIClass::customDoubleTransfer(const void * buf1, const void * buf2, size_t count_write1, size_t count_write2)
{
